...
/*Explanation:
In the above code, we first read a floating-point number x from the input using scanf. Then we print x with exactly 3 decimal places using printf with the format specifier "%.3f".*/